...
+
----
WINDUP_HOME/bin/windup --install org.jboss.windup.quickstarts:windup-ejb-beanutils-async-rules-java
----
...
+
----
WINDUP_HOME/bin/windup --remove org.jboss.windup.quickstarts:windup-ejb-beanutils-async-rules-java
----
