...
def metadata(source_path, html)
  ...
  if dir
    output = "<tr><td align='left'><a href='#{dir}/#{filename}.md' title='#{dir}'>#{dir}</td><td align='left'>#{summary}</td></tr>\n"
...
def markdown(source_path)
  ...
  if File.exist?(toc_file)
    ...
    qs_toc = "<table><thead><tr><th align='left'><strong>Quickstart Name</strong></th><th align='left'><strong>Description</strong></th></tr></thead><tbody>#{qs_toc_content}</table></table>"
